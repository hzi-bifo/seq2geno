...
if not sys.version.startswith("2.") or int(sys.version[2]) not in [6,7]:
   print >> sys.stderr,"Stampy requires Python version 2.6 or 2.7"
   sys.exit(1)
...
try:
    from Stampy import hashtable, genome, reader, formatter, mapper, singleendedmapper, recalibrate, mapstats, fastqformatter, utils, multithread, filez
except ImportError:
...
string_opts = ["genome=","logfile=","hash=","outputformat=","output=","inputformat=","stats=","keep-recalibrated=",
               ...
               "separator2=","bamsortprefix=","adapter-strip="]
multi_opts = []
...
int_opts =    ["verbosity=","bits=","maxcount=","maxscore=","minposterior=","numrecords=","lowqthreshold=","seed=",
               ...
               "bamsortbuflen=","bamsortmemory=","unclipq="]
