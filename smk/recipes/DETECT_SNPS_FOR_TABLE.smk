...
#include: os.path.join(RULE_LIB_DIR, 'for_tab_stampy_mapping', 'for_tab_stampy_mapping.smk')
include: os.path.join(RULE_LIB_DIR, 'for_tab_sam2fltvcf', 'for_tab_sam2fltvcf.smk')
include: os.path.join(RULE_LIB_DIR, 'for_tab_mapping', 'for_tab_mapping.smk')
