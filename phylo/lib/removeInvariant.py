...
parser.add_argument('--in', required= True, dest= 'i', help='input alignment')
parser.add_argument('--out', required= True, dest= 'o', help= 'output alignment')
parser.add_argument('--cn', dest= 'cutoff_num', help= 'least number of variant residue should be included in a column')
parser.add_argument('--s', dest= 'case_sensitive', default= False, action= 'store_true', help= 'case-sensitive (ie. A and a should be viewed differently)')
